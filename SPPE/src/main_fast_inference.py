...
class InferenNet(nn.Module):
    def __init__(self, dataset, weights_file='/content/rpms-fall-detect/Models/sppe/fast_res101_320x256.pth'):
        super().__init__()
...
class InferenNet_fast(nn.Module):
    def __init__(self, weights_file='/content/rpms-fall-detect/Models/sppe/fast_res101_320x256.pth'):
        super().__init__()
...
class InferenNet_fastRes50(nn.Module):
    def __init__(self, weights_file='/content/rpms-fall-detect/Models/sppe/fast_res50_256x192.pth'):
        super().__init__()
